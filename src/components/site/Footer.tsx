...
export function SiteFooter() {
  return (
    <footer
      style={{ background: "var(--navy-deep)", color: "rgba(255,255,255,0.82)", marginTop: "auto" }}
    >
      {/* ─── Top Grid ─── */}
      <div
      ...
      >
        ...
        <div style={{ gridColumn: "span 1" }}>
          ...
          >
            Preparing students for a wide range of IT careers — molding tomorrow's technocrats with
            high caliber and commitment since {DEPARTMENT.established}.
          </p>
          {/* Socials */}
          <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
            {[
              { href: DEPARTMENT.contact.youtube, Icon: Youtube, label: "YouTube" },
              { href: DEPARTMENT.contact.instagram, Icon: Instagram, label: "Instagram" },
            ].map(({ href, Icon, label }) => (
              <a
                key={label}
                href={href}
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.background = "var(--gist-orange)";
        ...
        <div>
          ...
          <ul style={{ display: "flex", flexDirection: "column", gap: 12, listStyle: "none" }}>
            ...
            >
              <MapPin
                size={14}
                style={{ marginTop: 2, flexShrink: 0, color: "var(--gold-soft)" }}
              />
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)" }}>
        ...
        >
          <span>
            © {new Date().getFullYear()} Geethanjali Institute of Science & Technology. All Rights
            Reserved.
          </span>
          <span style={{ display: "flex", gap: 16 }}>
            ...
            <a
              href="https://gist.edu.in/gist/contact-us/"
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: "rgba(255,255,255,0.5)" }}
            >
